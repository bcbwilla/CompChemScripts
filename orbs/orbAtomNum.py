...
atom_num_list = [43,44,45,46,48,51,52,53,54,56]

in_dictionary = {'C':[['2S','2PX','2PY','2PZ','3S','3PX','3PY','3PZ'],atom_num_list],'S':[['3S','3PX','3PY','3PZ','4S','4PX','4PY','4PZ'],atom_num_list], 'N':[['2S','2PX','2PY','2PZ','3S','3PX','3PY','3PZ'],atom_num_list]}

#in_dictionary = {'C':[['2S','2PX','2PY','2PZ','3S','3PX','3PY','3PZ'],[4,5,6]]}

#in_dictionary = {'S':[['3S','3PX','3PY','3PZ','4S','4PX','4PY','4PZ'],[5,10]]}

#in_dictionary = {'N':[['2S','2PX','2PY','2PZ','3S','3PX','3PY','3PZ'],[51,52,53,54,55,56]]}
...
#                if atom_num in in_d[atom][1]:           #check if atom is of desired number
			    for e in orb_d[atom][atom_num]:	    #given a desired atom of certain number, search look at orbitals
				    if e[0] in in_d[atom][0] and atom_num in in_d[atom][1]:		#if orbital is wanted, add to orbital_number_list
